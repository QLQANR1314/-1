...
class FindNewsflash extends StatefulWidget {
  const FindNewsflash({super.key});

  @override
  State<FindNewsflash> createState() => _FindNewsflashState();
}

class _FindNewsflashState extends State<FindNewsflash> with SingleTickerProviderStateMixin{
  // 定义原始数据
  List<String> items = [
    "1",
