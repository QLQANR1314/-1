...
import 'package:biyan_finance/models/error_message_model.dart';
...
const String BASE_URL = "https://dc.xiaba666.com/api";

class ByHttpUtil {
  static final ByHttpUtil _instance = ByHttpUtil._internal();
  factory ByHttpUtil() => _instance;

  late Dio _dio;

  /// 单例初始
  ByHttpUtil._internal() {
    // header 头
